...
- It's also been shown that users that experience usability frustration are less likely to have return visits.
...
#### Effort:
- Issue #1: Medium effort. It involves locating multiple read/write calculation calls and resolving layout thrashing issues. This is more mechanical but will likely require many changes throughout the system code.
...
#### Code Snippet:
- see /src/ for the two .js files that contain the current code and suggested new code as snippets
